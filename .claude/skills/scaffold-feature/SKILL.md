...
Đọc design docs → sinh DB schema thực tế + BE module stubs + FE page stubs — đủ để FE và BE bắt đầu implement ngay mà không cần setup thêm.
...
- Router/Controller stub: route decorators + endpoint stubs, schema/type từ api-contract — BE chỉ cần implement logic
- Service stub: method stubs tương ứng controller
- Repository stub: method stubs theo ORM đã chốt
- Request/Response schemas: fields từ api-contract
...
Điền seed script (theo ORM/framework đã chốt) với fake data thực tế cho demo:
