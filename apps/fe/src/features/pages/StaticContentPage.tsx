...
export default function StaticContentPage() {
    ...
    switch (key) {
      case 'return-policy':
        return {
          ...
          html: `
            <div class="space-y-4">
              <h3 class="text-xl font-bold text-[#3A1A0A]">1. Thời hạn Đổi trả Mô hình</h3>
              ...
              <h3 class="text-xl font-bold text-[#3A1A0A]">2. Phí vận chuyển hoàn trả</h3>
      ...
      case 'shipping-policy':
        return {
          ...
          html: `
            <div class="space-y-4">
              <h3 class="text-xl font-bold text-[#3A1A0A]">1. Phạm vi Giao Hàng</h3>
              ...
              <h3 class="text-xl font-bold text-[#3A1A0A]">2. Đóng gói bảo vệ</h3>
      ...
      default:
        return {
          ...
          icon: <HelpCircle size={28} className="text-[#5C3D1E]" />,
          html: `
            <div class="space-y-6">
              <div>
                <h4 class="text-lg font-bold text-[#3A1A0A]">Hộp mô hình tiểu cảnh có sử dụng đèn LED không?</h4>
              ...
              <div>
                <h4 class="text-lg font-bold text-[#3A1A0A]">Làm thế nào để bảo quản mica và khung gỗ?</h4>
  ...
  return (
    <div className="container mx-auto px-6 md:px-8 py-12 max-w-3xl space-y-8">
      ...
      {/* HTML Render */}
      <div
        className="text-sm text-[#2C1A0E] leading-relaxed space-y-4 prose reveal delay-75"
      ...
      <div className="pt-6 border-t border-[#D4B896]/30">
        <Link
          to="/"
          className="text-[11px] font-bold tracking-wider text-[#5C3D1E] hover:text-[#7B1C2E] uppercase transition-colors"
        >
          Quay lại trang chủ
        </Link>
      </div>
