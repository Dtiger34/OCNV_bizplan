  ...
  return (
    <div className="container mx-auto px-6 md:px-8 py-16 max-w-md text-center">
      {result !== 'cancel' && result !== 'CANCELLED' && result !== 'fail' ? (
        <div className="bg-[#fff8e7] border-[2px] border-[#C9973A] rounded-[8px] p-8 space-y-6 shadow-gold-glow">
          ...
          <div className="p-4 bg-[#fff8e7] border border-[#D4B896] rounded-md text-sm text-[#ab2124]">
          ...
          <div className="flex gap-4 pt-2">
            <Link
              to="/profile/orders"
              className="flex-1 h-10 bg-[#ab2124] hover:bg-[#ab2124] text-[#fff8e7] text-[11px] font-bold tracking-wider uppercase rounded-sm flex items-center justify-center gap-1.5 transition-all"
            >
              Xem Đơn Hàng
            </Link>
            <Link
              to="/"
              className="flex-1 h-10 border border-[#D4B896] text-[#ab2124] hover:bg-[#ab2124]/5 text-[11px] font-bold tracking-wider uppercase rounded-sm flex items-center justify-center gap-1.5 transition-all"
            >
              <Home size={14} />
              Trang Chủ
            </Link>
        ...
        <div className="bg-[#fff8e7] border-[2px] border-[#7B1C2E] rounded-[8px] p-8 space-y-6 shadow-large">
          ...
          <div className="flex gap-4 pt-2">
            <Link
              to="/checkout"
              className="flex-1 h-10 bg-[#7B1C2E] hover:bg-[#9B2438] text-[#fff8e7] text-[11px] font-bold tracking-wider uppercase rounded-sm flex items-center justify-center gap-1.5 transition-all"
            >
              Thử Lại
            </Link>
            <Link
