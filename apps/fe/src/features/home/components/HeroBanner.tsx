...
export default function HeroBanner() {
  ...
  return (
    <section className="relative w-full h-screen min-h-[600px] overflow-hidden -mt-20">
      ...
      <div className="absolute inset-0 flex flex-col justify-end pb-20 px-10 md:px-16 lg:px-24 max-w-4xl">
        <motion.p
        ...
        <motion.h1
          ...
          className="text-white font-bold text-5xl md:text-6xl lg:text-7xl leading-tight mb-6"
        >
        ...
        >
          <motion.button
            ...
            className="px-8 py-3 bg-white text-black text-sm font-semibold tracking-wide rounded-full hover:bg-white/90 transition-colors cursor-pointer"
          >
            Khám phá ngay
          </motion.button>
          <motion.button
            ...
            className="px-8 py-3 bg-transparent text-white text-sm font-semibold tracking-wide rounded-full border border-white/60 hover:border-white hover:bg-white/10 transition-colors cursor-pointer"
          >
